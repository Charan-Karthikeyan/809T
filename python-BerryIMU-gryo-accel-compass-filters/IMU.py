...
def detectIMU():
	...
	try:
		...
		print('error in reading LSM9DS0')        #need to do something here, so we just print a space
	else:
	...
	try:
		...
		print("XG value",LSM9DS1_WHO_XG_response)
		print("M response",LSM9DS1_WHO_M_response)
		
	except IOError as f:
		print('error in reading LSM9DS1')        #need to do something here, so we just print a space
	else:
